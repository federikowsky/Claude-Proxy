...
from llm_proxy.capabilities.generic_tool_misuse import classify_generic_tool_use
from llm_proxy.capabilities.ordinary_tool_emulation import classify_ordinary_with_control_emulation
...
class RuntimeActionClassifier:
    ...
    def __init__(self, tool_classifier=None) -> None:
        from llm_proxy.application.tool_classifier import get_default_classifier
