...
from llm_proxy.capabilities.builtins import builtin_capability_records
from llm_proxy.capabilities.enums import BridgeImplementationStatus, CapabilityInventoryClass
