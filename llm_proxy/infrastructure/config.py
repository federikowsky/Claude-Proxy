...
from llm_proxy.domain.enums import ActionPolicy, CompatibilityMode, ThinkingPassthroughMode
from llm_proxy.domain.errors import InternalBridgeError
from llm_proxy.jsonutil import json_loads

ENV_PREFIX = "LLM_PROXY__"
...
class RuntimePersistenceSettings(BaseModel):
    ...
    sqlite_path: str = "data/llm_proxy_runtime.db"
...
def load_settings(path: str | Path | None = None) -> Settings:
    config_path = Path(path or os.getenv("LLM_PROXY_CONFIG", DEFAULT_CONFIG_PATH))
