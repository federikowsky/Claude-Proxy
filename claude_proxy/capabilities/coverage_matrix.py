...
from claude_proxy.capabilities.enums import BridgeImplementationStatus, SchemaContractKind
from claude_proxy.capabilities.families import NON_TOOL_FAMILY_CLOSURE
from claude_proxy.capabilities.record import CapabilityRecord
from claude_proxy.capabilities.registry import get_capability_registry, is_mcp_style_tool_name
